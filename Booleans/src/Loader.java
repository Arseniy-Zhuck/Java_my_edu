...
public class Loader
{
    public static void main(String[] args)
    {
        ...
        if (powderAmount>=400 && sugarAmount>=10 &&  milkAmount>=1000 && oilAmount>=30)
        {
            ...
            } else if (appleCount >= 3 && milkAmount >= 100 && powderAmount >= 300 && eggsCount >= 4) {//apples - 3, milk - 100 ml, powder - 300 g, eggs - 4
                System.out.println("Apple pie");
            } else System.out.println("I only can make the pelmeni)))");
