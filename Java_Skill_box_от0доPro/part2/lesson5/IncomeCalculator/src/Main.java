...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println( (minInvestmentsAmount/(1.-mainTaxPercent)+
                (officeRentCharge + telephonyCharge + internetAccessCharge +
                assistantSalary + financeManagerSalary))/(1-managerPercent) );
        while (true) {
